import unittest
from gabriela import *

class TestGabriela(unittest.TestCase):
    def test_SayHi(self):
    ...
    def test_dict(self):
        ...
        self.assertEqual(d1, novoDict('Gabriela', 2014123456, False))
        self.assertEqual('Gabriela', getNome(d1))
